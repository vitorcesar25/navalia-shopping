 ...
 *
 * @return {Promise<void>} Sends a JSON response with the cart data and a 200 status code.
 *
 ...
 *
 *
 * @return {Promise<void>} Sends a JSON response with the updated cart data and a 200 status code.
