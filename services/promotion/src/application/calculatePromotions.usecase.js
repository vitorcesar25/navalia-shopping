 ...
 * @param {Array<Object>} cartItems - The items in the cart.
 * @return {Array<Object>} The applied promotions.
 */
 ...
 * @return {Object|null} The best promotion.
 */
 ...
 * @param {Array<Object>} cartItems - The items in the cart.
 * @param {boolean} isVip - Whether the user is a VIP.
 * @return {Promise<Object>} The applied promotions and the best offer.
 */
const calculatePromotions = async (cartItems, isVip) => {
  ...
  return {
    ...
    bestOfferId: bestPromotion ? bestPromotion.id : null,
  };
};
